Shader "Custom/WorleyTexVar1"
{
    ...
    SubShader
    {
        ...
        float randomNumGenerator(float2 gridPosition)
        {
           //Random number generator described by Patricio Gonzalez Vivo and Jen Lowe in The Book of Shaders
           return frac(sin(dot(gridPosition, float2(12.9898, 78.233))) * 43758.5453123);
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float distanceComb = noiseData.f2 - noiseData.f1;

            //use Color LUT to determine color of pixel
            float2 uv = float2(distanceComb, 0.5);

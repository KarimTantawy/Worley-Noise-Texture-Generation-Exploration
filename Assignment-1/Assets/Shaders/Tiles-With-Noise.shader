Shader "Custom/Tiles-With-Noise"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fractalValue = lerp(0.7, 1.0, fractalValue);
            ...
            float lutColor = smoothstep(0.0, 2.0, (1 - distanceComb) + fractalValue);

            //checking if it should be tile or edges between tile and determining the final LUT color that way
            lutColor = lutColor * step(0.05, distanceComb2);

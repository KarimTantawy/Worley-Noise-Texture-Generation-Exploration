Shader "Custom/WorleyTexVar4"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed4 c = tex2D(_MainTex, uv) * fixed4(fractalValue, fractalValue, fractalValue, 1.0);
     
            //fixed4 c = fixed4(fractalValue, fractalValue, fractalValue, 1.0);

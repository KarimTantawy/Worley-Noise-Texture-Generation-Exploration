Shader "Custom/Caustics"
{
    Properties
    {
        ...
        _LayerOneScale("Caustic Layer 1 Scale", Float) = 10.0
        _LayerOneRot("Caustic Layer 1 Rotation", Float) = 15.0
        _LayerTwoIntensity("Caustic Layer 2 Intensity", Range(0.0, 1.0)) = 0.5
        _LayerTwoScale("Caustic Layer 2 Scale", Float) = 10.0
        _LayerTwoRot("Caustic Layer 2 Rotation", Float) = 30.0
        _LayerThreeIntensity("Caustic Layer 3 Intensity", Range(0.0, 1.0)) = 0.5
        _LayerThreeScale("Caustic Layer 3 Scale", Float) = 10.0
        _LayerThreeRot("Caustic Layer 3 Rotation", Float) = 45.0
    }
    SubShader
    {
        ...
        {
            //generating the Worley noise data for each layer at different scales and rotations
            ...
            float distanceComb2 = noiseData2.f1;
